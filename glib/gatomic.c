 ...
 **/
gint
(g_atomic_int_get) (const gint *atomic)
{
 ...
 **/
gpointer
(g_atomic_pointer_get) (const void *atomic)
{
  return g_atomic_pointer_get ((const gpointer *) atomic);
}
